...
parser.add_argument('-is', '--input_size', default=224, type=int, help='输入图像尺寸,(is,is) -> (h,w)')
parser.add_argument('-t', '--tag', default='model', type=str, help='tag')
parser.add_argument('-wn', '--weights_name', default='model.pkl', type=str, help='读取模型的文件名')
